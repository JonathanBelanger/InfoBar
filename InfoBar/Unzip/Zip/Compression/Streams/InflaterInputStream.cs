...
using NightIguana.Unzip.Zip.Compression;
using NightIguana.Unzip.Checksums;

namespace NightIguana.Unzip.Zip.Compression.Streams 
{
	...
	public class InflaterInputBuffer
	{
		...
		public void Fill()
		{
			...
			while (toRead > 0) {
				...
				if ( count <= 0 ) {
					if (rawLength == 0) {
						throw new UnzipBaseException("Unexpected EOF"); 
					}
					break;
				}
				rawLength += count;
	...
	/// as the <see cref="NightIguana.Unzip.GZip.GZipInputStream">GZipInputStream</see>.
	///
	...
	public class InflaterInputStream : Stream
	{
		...
		public override int Read(byte[] buffer, int offset, int count) 
		{
			...
			{
				throw new UnzipBaseException("Need a dictionary");
			}
